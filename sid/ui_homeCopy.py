...
################################################################################
## Form generated from reading UI file 'homeCopy.ui'
##
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(1649, 951)
        self.centralwidget = QWidget(MainWindow)
        self.centralwidget.setObjectName(u"centralwidget")
        self.Home = QFrame(self.centralwidget)
        self.Home.setObjectName(u"Home")
        self.Home.setGeometry(QRect(110, 60, 1401, 691))
        ...
        self.schedButt.setGeometry(QRect(200, 500, 191, 61))
        ...
        self.menubar.setGeometry(QRect(0, 0, 1649, 26))
